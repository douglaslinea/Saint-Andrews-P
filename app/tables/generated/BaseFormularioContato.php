 ...
 */
abstract class BaseFormularioContato extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('formularioContato');
        ...
        $this->hasColumn('txt_endereco', 'string', 45, array(
             'type' => 'string',
             'length' => 45,
             'fixed' => false,
             'unsigned' => false,
