        ...
        <div id="wrapper-conteudo" class="clearfix">
            ...
            <section id="idiomas" class="clearfix">
                <div class="head-idiomas">
                    ...
                    {view}foreach from=$idioma_banco item=idiomas{/view}	

                    <!-- {view}if $idiommas=="pt-br"{/view} class="ativo" {view}/if{/view} -->
                    <a href="{view}$LANGUAGE_LINKS{/view}idioma/{view}$idiomas.txt_meta{/view}" {view}if $idiomas.cod_id== $IDIOMA_DEFAULT{/view} class="ativo" {view}/if{/view} > {view}$idiomas.txt_idioma{/view}</a>| 
