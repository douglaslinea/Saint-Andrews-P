...
class Helper {
	...
	{
		header("HTTP/1.0 404 Not Found"); //Envia um cabeçalho HTTP informando que a página não foi encontrada não remova esta linha
		include_once("404.html"); //Redireciona para a pagina de erro 404
		exit(); //Trava a aplicação por segurança
	}
	...
	public function getPermalink($full_permalink=false)
	{
		...
		//Verifica se é necessário pegar o Permalink inteiro ex: produtos/categoria/editar ou somente o id ex: produtos/categoria/1-categoria_teste
		if($full_permalink)
		{
			//Recebe o permalink
